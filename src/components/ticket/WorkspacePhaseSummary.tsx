...
const CONTEXT_KEY_LABELS: Record<WorkflowContextKey, { label: string; description: string }> = {
  ...
  execution_setup_profile: { label: 'Execution Setup Profile', description: 'A compact reusable runtime profile produced by the execution setup phase. It records setup roots, discovered command families, reusable artifacts, and the quality-gate policy later coding beads should follow.' },
