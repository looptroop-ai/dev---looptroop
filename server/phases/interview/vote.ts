...
import { buildPromptFromTemplate, PROM2 } from '../../prompts/index'
import type { PromptPart } from '../../opencode/types'

export async function voteInterview(
  ...
  const promptContent = buildPromptFromTemplate(PROM2, ticketContext.map(p => ({ type: p.type, content: p.content })))
