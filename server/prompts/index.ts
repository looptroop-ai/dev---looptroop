...
export const PROM10a: PromptTemplate = {
  ...
  instructions: [
    ...
    'Choice Rule: For `single_choice` and `multiple_choice` questions, populate canonical `selected_option_ids` using the provided option IDs. Do not answer choice questions with free-text labels alone.',
    'Length Safety: If output length is a concern, shorten answer text instead of omitting later question blocks, trailing sections, or the final approval block.',
    'No Planning Mode: Do not read files, search for more context, propose an implementation plan, or describe next steps. Return only the completed interview artifact.',
