...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"LoopTroop","description":"Durable repo-scale AI delivery through council planning, isolated worktrees, and explicit approvals.","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"siteTitle":"LoopTroop Docs","nav":[{"text":"Home","link":"/"},{"text":"Workflow","link":"/ticket-flow"},{"text":"Architecture","link":"/system-architecture"},{"text":"Roadmap","link":"/roadmap"},{"text":"GitHub","link":"https://github.com/looptroop-ai/dev---looptroop"}],"sidebar":[{"text":"Start Here","collapsed":false,"items":[{"text":"Home","link":"/"},{"text":"Getting Started","link":"/getting-started"},{"text":"Core Philosophy","link":"/core-philosophy"},{"text":"FAQ","link":"/faq"}]},{"text":"Workflow","collapsed":false,"items":[{"text":"Ticket Flow","link":"/ticket-flow"},{"text":"State Machine","link":"/state-machine"},{"text":"LLM Council","link":"/llm-council"},{"text":"Beads","link":"/beads"},{"text":"Execution Loop","link":"/execution-loop"}]},{"text":"Architecture","collapsed":false,"items":[{"text":"System Architecture","link":"/system-architecture"},{"text":"Context Isolation","link":"/context-isolation"},{"text":"OpenCode Integration","link":"/opencode-integration"},{"text":"Frontend","link":"/frontend"},{"text":"Database Schema","link":"/database-schema"}]},{"text":"Reference","collapsed":false,"items":[{"text":"API Reference","link":"/api-reference"}]},{"text":"Direction","collapsed":false,"items":[{"text":"Roadmap","link":"/roadmap"}]}],"search":{"provider":"local"},"outline":{"level":[2,3],"label":"On this page"},"editLink":{"pattern":"https://github.com/looptroop-ai/dev---looptroop/edit/main/docs/:path","text":"Edit this page on GitHub"},"socialLinks":[{"icon":"github","link":"https://github.com/looptroop-ai/dev---looptroop"}],"docFooter":{"prev":"Previous","next":"Next"},"footer":{"message":"LoopTroop documentation for the current runtime.","copyright":"Built for durable repository-scale AI delivery."}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$t = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.BdIz7xsB.js"));
  ...
  setup(__props) {
    ...
    async function renderDiagram() {
      ...
      try {
        ...
        bindFunctions == null ? void 0 : bindFunctions(container.value);
      } catch (err) {
        container.value.innerHTML = "";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<figure${ssrRenderAttrs(mergeProps({ class: "mermaid-block" }, _attrs))}><div class="${ssrRenderClass([{ "is-hidden": Boolean(error.value) }, "mermaid-diagram"])}"></div>`);
      if (error.value) {
        _push(`<div class="mermaid-fallback"><p class="mermaid-error">Mermaid render error: ${ssrInterpolate(error.value)}</p><pre><code>${ssrInterpolate(source.value)}</code></pre></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</figure>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/MermaidBlock.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const RawTheme = {
  extends: theme,
  enhanceApp({ app }) {
    app.component("MermaidBlock", _sfc_main);
  }
};
